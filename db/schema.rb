...
ActiveRecord::Schema.define(version: 20170420204356) do
  ...
  add_index "order_shipping_addresses", ["order_id"], name: "index_order_shipping_addresses_on_order_id", using: :btree
  add_index "order_shipping_addresses", ["user_id"], name: "index_order_shipping_addresses_on_user_id", using: :btree
  ...
  add_foreign_key "order_shipping_addresses", "users"
